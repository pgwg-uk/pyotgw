MSG_STATUS = b"\x00"  # 00
MSG_TSET = b"\x01"  # 01
MSG_MCONFIG = b"\x02"  # 02
MSG_SCONFIG = b"\x03"  # 03
MSG_COMMAND = b"\x04"  # 04
MSG_ASFFLAGS = b"\x05"  # 05
MSG_RBPFLAGS = b"\x06"  # 06
MSG_COOLING = b"\x07"  # 07
MSG_TSETC2 = b"\x08"  # 08
MSG_TROVRD = b"\x09"  # 09
MSG_TSP = b"\x0A"  # 10
MSG_TSPIDX = b"\x0B"  # 11
MSG_FHBSIZE = b"\x0C"  # 12
MSG_FHBIDX = b"\x0D"  # 13
MSG_MAXRMOD = b"\x0E"  # 14
MSG_MAXCAPMINMOD = b"\x0F"  # 15
MSG_TRSET = b"\x10"  # 16
MSG_RELMOD = b"\x11"  # 17
MSG_CHPRESS = b"\x12"  # 18
MSG_DHWFLOW = b"\x13"  # 19
MSG_TIME = b"\x14"  # 20
MSG_DATE = b"\x15"  # 21
MSG_YEAR = b"\x16"  # 22
MSG_TRSET2 = b"\x17"  # 23
MSG_TROOM = b"\x18"  # 24
MSG_TBOILER = b"\x19"  # 25
MSG_TDHW = b"\x1A"  # 26
MSG_TOUTSIDE = b"\x1B"  # 27
MSG_TRET = b"\x1C"  # 28
MSG_TSTOR = b"\x1D"  # 29
MSG_TCOLL = b"\x1E"  # 30
MSG_TFLOWCH2 = b"\x1F"  # 31
MSG_TDHW2 = b"\x20"  # 32
MSG_TEXHAUST = b"\x21"  # 33
MSG_HXTEMP = b"\x22"  # 34
MSG_FANSPD = b"\x23"  # 35
MSG_BCURRENT = b"\x24"  # 36
MSG_TROOM2 = b"\x25"  # 37
MSG_RELHUM = b"\x26"  # 38
MSG_TDHWSETUL = b"\x30"  # 48
MSG_TCHSETUL = b"\x31"  # 49
MSG_OTCCURVEUL = b"\x32"  # 50
MSG_TDHWSET = b"\x38"  # 56
MSG_MAXTSET = b"\x39"  # 57
MSG_OTCCURVE = b"\x3A"  # 58
MSG_STATUSVH = b"\x46"  # 70
MSG_RELVENTPOS = b"\x47"  # 71
MSG_VHFAULT = b"\x48"  # 72
MSG_VHOEMDIAG = b"\x49"  # 73
MSG_SLAVEVH = b"\x4A"  # 74
MSG_VHVERSION = b"\x4B"  # 75
MSG_VHPRODUCT = b"\x4C"  # 76
MSG_RELVENT = b"\x4D"  # 77
MSG_RHEXHAUST = b"\x4E"  # 78
MSG_CO2EXHAUST = b"\x4F"  # 79
MSG_TSPLYIN = b"\x50"  # 80
MSG_TSPLYOUT = b"\x51"  # 81
MSG_TEXHIN = b"\x52"  # 82
MSG_TEXHOUT = b"\x53"  # 83
MSG_EXFANSPD = b"\x54"  # 84
MSG_SPLYFANSPD = b"\x55"  # 85
MSG_VHROVRD = b"\x56"  # 86
MSG_NRELVENT = b"\x57"  # 87
MSG_VHNUMTSPS = b"\x58"  # 88
MSG_VHTSPIDX = b"\x59"  # 89
MSG_VHFHBSIZE = b"\x5A"  # 90
MSG_VHFHBIDX = b"\x5B"  # 91
MSG_RFINFO = b"\x62"  # 98
MSG_OPMODES = b"\x63"  # 99
MSG_ROVRD = b"\x64"  # 100
MSG_SOLARSTATUS = b"\x65"  # 101
MSG_SOLAROEMDIAG = b"\x66"  # 102
MSG_SLAVESOLARINFO = b"\x67"  # 103
MSG_SOLARVERSION = b"\x68"  # 104
MSG_SOLARNUMTSPS = b"\x69"  # 105
MSG_SOLARTSPIDX = b"\x6A"  # 106
MSG_SOLARFHBSIZE = b"\x6B"  # 107
MSG_SOLARFHBIDX = b"\x6C"  # 108
MSG_ELPRODSTARTS = b"\x6D"  # 109
MSG_ELPRODHRS = b"\x6E"  # 110
MSG_ELPROD = b"\x6F"  # 111
MSG_ELPRODCUM = b"\x70"  # 112
MSG_BURNSTARTFAILS = b"\x71"  # 113
MSG_FLAMELOWCOUNT = b"\x72"  # 114
MSG_OEMDIAG = b"\x73"  # 115
MSG_BURNSTARTS = b"\x74"  # 116
MSG_CHPUMPSTARTS = b"\x75"  # 117
MSG_DHWPUMPSTARTS = b"\x76"  # 118
MSG_DHWBURNSTARTS = b"\x77"  # 119
MSG_BURNHRS = b"\x78"  # 120
MSG_CHPUMPHRS = b"\x79"  # 121
MSG_DHWPUMPHRS = b"\x7A"  # 122
MSG_DHWBURNHRS = b"\x7B"  # 123
MSG_OTVERM = b"\x7C"  # 124
MSG_OTVERS = b"\x7D"  # 125
MSG_MVER = b"\x7E"  # 126
MSG_SVER = b"\x7F"  # 127
